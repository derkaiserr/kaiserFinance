    ...
    <div>
      <figure className=" w-full  bg-no-repeat ">
        ...
        <div className="relative">
          ...
          />
          <img
            className="bg-inherit absolute h-[10vh] mx-auto left-0 right-0 -translate-x-[130%] z-20 top-12"
            src={Coin}
            alt=""
          />
          <img
            className="bg-inherit absolute h-[10vh] mx-auto left-0 right-0 translate-x-[125%] z-20 translate-y-[2.4cm]"
            src={Donut}
            alt=""
          />
        </div>
